...
![DownloadCountTotal](https://img.shields.io/github/downloads/joyrider3774/trimui_brick_games/total?label=total%20downloads&style=plastic) ![DownloadCountLatest](https://img.shields.io/github/downloads/joyrider3774/trimui_brick_games/latest/total?style=plastic) ![LatestVersion](https://img.shields.io/github/v/tag/joyrider3774/trimui_brick_games?label=Latest%20version&style=plastic) ![License](https://img.shields.io/github/license/joyrider3774/trimui_brick_games?style=plastic)

Builds of my games running on Trimui Brick

## Installing
In general on the Trimui Brick, enable usb disk mode and connect your Trimui Brick to your pc.
On the drive that appears from it there should be an `Apps` folder, extract the zips you download from the 
[Release Section](https://github.com/joyrider3774/trimui_brick_games/releases) in this folder.
For example if you open `checkers - Trimui_Brick.zip` there will be a folder inside, in this example named
`checkers` you need to copy that folder to the `Apps` folder of your Trimui Brick disk. 
...
[Game Info](https://joyrider3774.github.io/blips_playdate/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/blips.-.Trimui_Brick.zip)
...
[Game Info](https://joyrider3774.github.io/blockdude_playdate/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/blockdude.-.Trimui_Brick.zip)
...
- I had to enable No Scaled Drawing mode for trimui Brick because it's not being able to run the games fullspeed otherwise, this means overlays like glow, pixel grid and crt effect are also disabled !
- A and B Button are swapped on the Trimui Brick (it follows xbox controller layout)

[Game Info](https://joyrider3774.github.io/crisp-game-lib-portable-sdl/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/cglpsdl2.-.Trimui_Brick.zip)
...
Checkers is the well known board game with four difficulties and a jump heuristic. This version is port of my gp2x version made to work with the Trimui Brick handheld.

[Game Info](https://joyrider3774.github.io/checkers_playdate/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/checkers.-.Trimui_Brick.zip)
...
Dynamate is a puzzle game invented by Björn Kalzen and Jonas Norberg, a couple of years ago i contacted them to make a port for the gp2x handheld. This version is port of my gp2x version made to work with the Trimui Brick handheld.

[Game Info](https://joyrider3774.github.io/dynamate_playdate/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/dynamate.-.Trimui_Brick.zip)
...
[Game Info](https://joyrider3774.github.io/formula1_playdate/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/formula_1.-.Trimui_Brick.zip)
...
[Game Info](https://joyrider3774.github.io/mazethingie_playdate/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/mazethingie.-.Trimui_Brick.zip)
...
[Game Info](https://joyrider3774.github.io/sokoban_playdate/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/playdoban.-.Trimui_Brick.zip)
...
[Game Info](https://joyrider3774.github.io/rubido_playdate/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/rubido.-.Trimui_Brick.zip)
...
[Game Info](https://joyrider3774.github.io/puzzleland_playdate/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/puzzleland.-.Trimui_Brick.zip)
...
[Game Info](https://joyrider3774.github.io/puztrix_playdate/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/puztrix.-.Trimui_Brick.zip)
...
[Game Info](https://joyrider3774.github.io/RetroTime/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/retrotime.-.Trimui_Brick.zip)
...
Waternet is a multiplatform puzzle game written for old consoles and handhelds like Game Boy (Color), Game Gear, Master System, Analogue Pocket and Mega Duck and now also Trimui Brick! It's a combination of the net and netslide games from the simon tatham's puzzle collection!

[Game Info](https://joyrider3774.github.io/waternet_playdate/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/waternet.-.Trimui_Brick.zip)
...
[Game Info](https://joyrider3774.github.io/Znax/) - [Download for Trimui Brick](https://github.com/joyrider3774/trimui_brick_games/releases/latest/download/znax.-.Trimui_Brick.zip)
